...
public class PlayerMovement2022 : MonoBehaviour
{
    public PlayerHealth2022 playerHealthScript;         //creates a new reference to the player health script we made
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                this.transform.Translate(Vector3.up * Time.deltaTime * movementSpeed);          //this object move forward
            }
